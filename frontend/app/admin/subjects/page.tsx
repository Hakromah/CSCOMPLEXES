          ...
          <div className="max-h-[620px] overflow-y-auto pr-1 p-2">
            ...
            >
              {filteredSubjects.map((subject) => (
                ...
                >
                  <div className="bg-white rounded-3xl p-5 sm:shadow-sm border border-slate-100 max-sm:border-primary/30 md:hover:border-primary duration-500 hover:shadow-2xl hover:-translate-y-2 transition-all h-full flex flex-col justify-between">
