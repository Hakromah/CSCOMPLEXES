...
export default {
  routes: [
    ...
    { method: 'GET', path: '/student/invoices',                            handler: 'school-student.getMyInvoices' },
    { method: 'GET', path: '/student/balance',                             handler: 'school-student.getMyBalance' },
    { method: 'GET', path: '/student/payments',                            handler: 'school-student.getMyPayments' },
    { method: 'GET', path: '/student/finance/payments',                    handler: 'school-student.getMyPayments' },
    { method: 'GET', path: '/student/statement',                           handler: 'school-student.getMyStatement' },
    { method: 'GET', path: '/student/finance/statement',                   handler: 'school-student.getMyStatement' },
    ...
    { method: 'GET', path: '/student/events',                             handler: 'school-student.getMyEvents' },
    { method: 'GET', path: '/student/notifications',                      handler: 'school-student.getMyNotifications' },
    { method: 'GET', path: '/student/transcripts/auto',                   handler: 'school-student.getAutoTranscript' },
    { method: 'GET', path: '/student/academic-results',                   handler: 'school-student.getMyAcademicResults' },
  ],
};
